 ...
 * @version $Id: SqlParser.java 217 2011-08-06 14:06:47Z gerald.chen.hz@gmail.com $
 */
public class SqlParser {
	...
	private static String getSelectColString(String sql) {
		final String sqlx = sql.substring(0, sql.toLowerCase().indexOf("from"));
		Pattern pattern = Pattern.compile("(select\\s+)(.+)(\\s+)", Pattern.CASE_INSENSITIVE);

		Matcher matcher = pattern.matcher(sqlx);
