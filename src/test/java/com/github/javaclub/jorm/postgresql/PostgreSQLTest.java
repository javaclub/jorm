 ...
 * @version $Id: PostgreSQLTest.java 479 2011-09-26 14:01:29Z gerald.chen.hz $
 */
public class PostgreSQLTest {
	...
	public void testUpdateUuid() {
		UserBean user = new UserBean("0913a736030846debbd3582480055b98", "IG6Qyu", "男", 998, "Java高级开发工程师");
		session.update(user);
		System.out.println(user.getId());
	}
	...
	public void testExsitsTable() {
		...
		flag = session.existsTable("postgres", "tbtest");
		Assert.assertTrue(flag == true);
	}
	...
	public void testRead2() {
		UserBean user = session.read(UserBean.class, "dde1b11fb8664fa5a8f3842f8f0030ab", "EBy2l0");
		System.out.println(user);
		...
		UserBean user4 = session.loadFirst(UserBean.class, "SELECT * FROM t_user_entity WHERE user_name LIKE ? AND u_age > ?", "egH%", 18);
		System.out.println(user4);
	}
	
	@Test
	public void testRead3() {
		String user = session.loadFirst(String.class, "SELECT user_id FROM t_user_entity WHERE user_name = 'egHfQZ'");
		System.out.println(user);
