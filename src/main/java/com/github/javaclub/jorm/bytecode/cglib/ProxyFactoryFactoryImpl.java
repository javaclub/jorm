/*
 * @(#)ProxyFactoryFactoryImpl.java	2011-9-1
 *
...
import com.github.javaclub.jorm.bytecode.BasicProxyFactory;
import com.github.javaclub.jorm.bytecode.ProxyFactoryFactory;
import com.github.javaclub.jorm.proxy.ProxyFactory;
import com.github.javaclub.jorm.proxy.pojo.cglib.CGLIBProxyFactory;

/**
 * A factory for CGLIB-based {@link ProxyFactory} instances.
 *
 * @author <a href="mailto:gerald.chen.hz@gmail.com">Gerald Chen</a>
 * @version $Id: ProxyFactoryFactoryImpl.java 2011-9-1 下午01:55:46 Exp $
 */
	...
	public static class BasicProxyFactoryImpl implements BasicProxyFactory {
		...
		public BasicProxyFactoryImpl(Class superClass, Class[] interfaces) {
			if ( superClass == null && ( interfaces == null || interfaces.length < 1 ) ) {
				throw new FailureLog( "attempting to build proxy without any superclass or interfaces" );
			}
			...
			try {
				...
				throw new JormException( "Unable to build CGLIB Factory instance" );
			}
		}
		...
		public Object getProxy() {
			try {
				...
				throw new JormException( "Unable to instantiate proxy instance" );
			}
		}
	}
