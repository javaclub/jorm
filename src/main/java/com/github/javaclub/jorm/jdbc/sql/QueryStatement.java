 ...
 * @version $Id: QueryStatement.java 2011-10-8 下午03:18:19 Exp $
 * @since 1.0.7
 */
...
public class QueryStatement {
	...
	public QueryStatement(Dialect dialect) {
	...
	public QueryStatement copy() {
		QueryStatement copy = new QueryStatement(dialect);
